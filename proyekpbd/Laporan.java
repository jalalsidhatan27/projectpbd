...
public class Laporan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No Nota", "Jumlah Penghasilan", "Jumlah Pengeluaran", "Laba"
            }
        ) {
        ...
        bg.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 210, 720, 440));

        btntambah.setText("Tambah");
        bg.add(btntambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 90, 30));

        btnhapus.setText("Hapus");
        bg.add(btnhapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 90, 30));

        btnedit.setText("Edit");
        bg.add(btnedit, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 150, 90, 30));

        btnsimpan.setText("Simpan");
        bg.add(btnsimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 150, 90, 30));
